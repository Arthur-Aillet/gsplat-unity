...
namespace Gsplat
{
    public class GsplatRendererImpl
    {
        ...
        static readonly int k_slider = Shader.PropertyToID("_Slider");
        ...
        public void Render(uint splatCount, Transform transform, Bounds localBounds, int layer,
            bool gammaToLinear = false, int shDegree = 3, float slider = 0f)
        {
            ...
            m_propertyBlock.SetFloat(k_slider, slider);
